...
class FahadEventCard extends PureComponent {
  ...
  render() {
    ...
    let {modalIsOpen, finished} = this.state
    return (
        <React.Fragment>
          {
            !finished ? <div className="event-card">
                  <FahadEventModal modalIsOpen={modalIsOpen} toggle={this.toggle} _finished={this.setFinished} _createProduct={_createProduct}/>
