...
const mapStateToProps = (state) => ({
    allExchanges: state.exchanges.list.allExchanges,
    currentUserType: state.auth.client.user_type,
    currentUserIdentity: state.auth.client.identity.id,
    currentUserId: state.auth.client.identity.identity_user.id,
})
