    ...
    return (
      <div className={`row ${className}`}>
        ...
        {/*<div className="col-1 d-flex flex-column align-items-end -my-icons1">*/}
          {/*{(tab === 'dashboard') ?*/}
            {/*<Link className="active" to="exchanges/exchange_explorer"><FontAwesome className="dashboard-icon"*/}
                                                                                  {/*name="dashboard"/></Link> :*/}
            {/*<Link to="exchanges/exchange_explorer"><FontAwesome className="dashboard-icon" name="dashboard"/></Link>}*/}
