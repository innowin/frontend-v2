        ...
        return (
            <div>
                ...
                <Collapse isOpen={collapse} className={`-topBar-right-collapse col-3 pr-0 pl-0 ${collapseWidthCol}`}>
                    <ul>
                        <li onClick={this._handleExchangeUpgrade}><i className="fa fa-home"/> درخواست ارتقاء به کارگزار
                        </li>
                ...
                {/*/>*/}
                <AddingContribution modalIsOpen={productWizardModalIsOpen} handleModalVisibility={this._handleProductWizardModal} />
            </div>
        )
    }
}
