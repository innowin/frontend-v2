            ...
            {!isEdit
                ...
                <React.Fragment>
                  ...
                  <ConfirmDeleteModal translate={translate} closer={() => this._toggleDeleteResume()}
                                      deleteEntity={() => this._deleteResume(resume.id)} open={isDelete}/>
                </React.Fragment>
                : <ResumeForm translate={translate} owner={owner}
                              toggleEdit={() => this._toggleEditResume()}/>
            }
          </div>
        </React.Fragment>
    )
