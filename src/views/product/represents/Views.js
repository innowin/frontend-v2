...
export class RepresentItemWrapper extends Component {
  render() {
    return (
      <div className="-itemWrapperRepresent">
        {this.props.children}
      </div>
    )
  }
...
export class RepresentFooter extends Component {
  ...
  render() {
    ...
    return (
      <div className="-item-footerRepresent">
        <div>
      ...
      <VerifyWrapper isLoading={isLoading} error={error}>
        <RepresentItemWrapper>
          <div className="-img-col">
            ...
            <img className="-item-imgRepresent rounded-circle" src={profile_media_File || defaultImg} alt=""/>
          </div>
          <div className="-content-col">
            <RepresentItemHeader
              ...
              showEdit={showEdit}
            />
            <RepresentBody description={represent.represent_description}/>
