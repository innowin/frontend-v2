...
import CircularAddIcon from "../../../images/common/circularAdd_svg"
import InformationIcon from "../../../images/common/information_svg"
import ItemsAndPropertiesIcon from "../../../images/common/ItemsAndProperties_svg"
...
import TipsIcon from "../../../images/common/tips_svg_icon"
...
class AddingContribution extends Component<AddingContributionProps, AddingContributionState> {
    constructor(props) {
        ...
        this.renderCurrentLevel = this.renderCurrentLevel.bind(this)
                  ...
                  <div>
                      ...
                      <div className={"contribution-description-options-area"}>
                          ...
                          <div className={"contribution-description-options"}>
                              <div className={"contribution-description-option-block"}>
