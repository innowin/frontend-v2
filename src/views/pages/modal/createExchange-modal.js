...
class PageOne extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      images: [{
        ...
        id: 1
      }, {file: "http://restful.daneshboom.ir/media/a6c0c4fea76d4b96ba6fe17d11a1afd3.jpg", id: 2}],
      currentImage: "",
      isLoading: false,
  ...
  handleNext() {
    if (this._validateInput()) {
      this.props.saveState({
        ...
        exchange_image: this.state.exchange_image,
  ...
  render() {
    ...
    const imgViews = images.map((val, idx) => {
      return (
          <div className="img-agent-small"><ImageViewerAgent key={idx} idx={idx}
                                                             selected={self.state.selectedIdx == idx ? true : false}
                                                             src={val} imageSelect={this.changeImage}/></div>)
    })
    return (<div>
      <div className="modal-hint ">
        <div className="row">
          ...
          <div className="col-10 text-right">
            توضیح مختصر از بورس توضیح مختصر از بورس توضیح مختصر از بورس توضیح مختصر از بورس توضیح مختصر از بورس توضیح
          ...
          <div className="col m-2" dir="ltr">
            <div className="row" dir="rtl">
              <div className="col">
                ...
                }} defaultValue={this.state.name} className="form-control white-text-input"/>
              </div>
            </div>
            <div className="row create-exchange-options">
              <div className="col">
                <div className="form-check form-check-inline">
                  ...
                  }} type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option1"
              ...
              <div className="col">
                <div className="form-check form-check-inline">
                  <input className="form-check-input" ref={(isPrivateInput) => {
                    this.isPrivateInput = isPrivateInput
                  }} onChange={(e) => {
                    this.setState({private: e.target.checked})
            ...
            <div className="row create-exchange-options" dir="ltr">
              <label htmlFor="exchangeUser"
                     className="col-sm-2 exchangeUser-label"><strong>http://dbm.ir/</strong></label>
              <div className="col-sm-10">

                <input type="text" ref={(exchangeLinkInput) => {
                  this.exchangeLinkInput = exchangeLinkInput
                }} onChange={(e) => {
                  this.setState({link: "http://dbm.ir/" + e.target.value})
                }} defaultValue={this.state.link.replace("http://dbm.ir/", "")}
                       className="form-control  white-text-input" id="exchangeUser" placeholder="نام کاربری بورس"
                       dir='rtl'/>
              </div>
            </div>
          </div>
                  ...
                  <div className="img-agent-small">
                    <input type="file"
                           ...
                           ref={(inputOpenFileRef) => {
                             this.inputOpenFileRef = inputOpenFileRef
                           }}
                    ...
                    <ImageViewerAgent key={'chooser'} idx={-1} selected={false}
                                      src={{file: "http://www.arcdocendi.com/Forms/images/upload.png"}}
                                      imageSelect={this.showOpenFileDlg.bind(this)}/>
                  </div>
                  {imgViews}
                </div>
...
class PageTwo extends Component {
  ...
  handleRemoveTag(idx) {
    ...
    let index = tags.findIndex(function (cus) {
      return cus.idx === idx
    });
    if (index !== -1) {
      tags.splice(index, 1);
    ...
    return (<div>
      <div className="modal-hint create-exchange-modal">
        <div className="row">
          ...
          <div className="col-10 text-right">
            اهمیت توصیف بورس و برچسب ها اهمیت توصیف بورس و برچسب ها اهمیت توصیف بورس و برچسب ها اهمیت توصیف بورس و برچسب
            ها اهمیت توصیف بورس و برچسب ها
          </div>
        </div>
      </div>
      <div className="modal-body-create-exchange">
          ...
          <div className="col m-2" dir="ltr">
            <div className="row full-height" dir="rtl">
              <div className="col">
                ...
                <textarea className="form-control white-text-input exchange-description full-height" id="" rows="3"
                          onChange={(e) => {
...
class PageThree extends Component {
  ...
  handleAddUser(index, user) {
    ...
    let foundIndex = added.findIndex(function (cus) {
      return cus.idx === index;
    })
    if (foundIndex == -1) {
  ...
  render() {
    ...
    let usersView = Object.values(users).map((user, idx) => {
      return <MemberItem added={self.state.added.findIndex(function (cus) {
        return cus.idx === idx;
      }) != -1 ? true : false}
                         index={idx}
                         key={user.id}
  ...
  render() {
    ...
    return (
        <div className="success-message">
          ...
          <p className="exchange-address">آدرس بورس:‌ daneshboom.ir/someFakeExchange</p>
          <div className="modal-footers">
            <NextPrevBtns
                prevBtnTitle="پایان"
                nextBtnTitle="اشتراک"
...
class CreateExchangeForm extends Component {
  ...
  createExchange() {
    ...
    for (let i = 0; i < addedUsers.length; i++) {
      const user = users[addedUsers[i].user.id] || {}
      const identity = user.identity || {}
      createExchangeMembership({identityId: identity.content})
    }
  ...
  render() {
    ...
    if (!this.state.isLoading) {
      return (
          ...
          <div
              className={this.props.active ? "modal-dialog exchanges-modal modal-lg modal-page create-exchange-wrapper" : "modal-page create-exchange-wrapper hide"}
              tabIndex="-1" role="dialog" ref={this.setWrapperRef}>
      ...
      return (
          <div
              className={this.props.active ? " modal-page create-exchange-wrapper" : "modal-page create-exchange-wrapper hide"}
              tabIndex="-1" role="dialog" ref={this.setWrapperRef}>
...
const mapDispatchToProps = dispatch => ({
  actions: bindActionCreators({
    ...
    getIdentityByUserId: GetUserActions.getUserByUserId,
