module.exports = {
  ...
  'Post not removed error': 'حذف پست با مشکل مواجه شد',
  ...
  'Close': 'بستن',
  'hire': 'علاقه‌مند به فرصت های شغلی',
  'full_time_hire': 'به دنبال کار تمام وقت',
  'part_time_hire': 'به دنبال کار پاره وقت',
  'internship_hire': 'به دنبال فرصت کارآموزی',
  'not_hiring': 'علاقه‌مند به فرصت ‌های شغلی نیستم',
  'hire_org': 'علاقه‌مند به جذب نیرو',
  'full_time_hire_org': 'کارت تمام وقت',
  'part_time_hire_org': 'کار پاره وقت',
  'internship_hire_org': 'فرصت کارآموزی',
  'not_hiring_org': 'جذب نیرو نداریم',
}