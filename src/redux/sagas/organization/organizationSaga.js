...
function* getExchanges(action) {
  ...
  try {
    ...
    const {message} = e
    yield put({type: types.ERRORS.ORGANIZATION.GET_ORG_EXCHANGES, payload: {type: types.ERRORS.ORGANIZATION.GET_ORG_EXCHANGES, message}})
  } finally {
    socketChannel.close()
  }
}
...
function* getOrgIdentity(action) {
  ...
  try {
    ...
    const {message} = e
    yield put({type: types.ERRORS.ORGANIZATION.GET_USER_IDENTITY, payload: {type: types.ERRORS.ORGANIZATION.GET_USER_IDENTITY, message}})
  } finally {
    socketChannel.close()
    return res
  }
...
function* getFollowing(follow_followed) {
  ...
  try {
    ...
    const {message} = e
    yield put({type: types.ERRORS.ORGANIZATION.GET_ORG_FOLLOWING, payload: {type: types.ERRORS.ORGANIZATION.GET_ORG_FOLLOWING, message}})
  } finally {
    socketChannel.close()
  }
}
...
function* getCustomers(action) { //TODO amir
  ...
  try {
    ...
    const {message} = e
    yield put({type: types.ERRORS.ORGANIZATION.GET_ORG_CUSTOMERS, payload: {type: types.ERRORS.ORGANIZATION.GET_ORG_CUSTOMERS, message}})
  } finally {
    socketChannel.close()
  }
}
...
function* updateCertificate(action) { //TODO amir change URL nad QUERY
  ...
  try {
    ...
    const {message} = e
    yield put({type: types.ERRORS.ORGANIZATION.UPDATE_CERTIFICATE, payload: {type: types.ERRORS.ORGANIZATION.UPDATE_CERTIFICATE, error: message}})
  } finally {
    socketChannel.close()
    hideEdit()
  }
