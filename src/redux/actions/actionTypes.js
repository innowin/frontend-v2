...
const types = {
	...
	SUCCESS : {
		...
		//FixMe Amir: duplicated declaration : GET_ORG_FOLLOWERS
	...
	UPDATE_PRODUCT_FAILED: 	'UPDATE_PRODUCT_FAILED', // should move to ERRORS
	CREATE_PRODUCT_FAILED : 'CREATE_PRODUCT_FAILED', // should move to ERRORS
	DELETE_PRODUCT_FAILED : 'DELETE_PRODUCT_FAILED', // should move to ERRORS
