...
const getAllUsers = (state) => {
  ...
  if (state.users.search)
    return Object.values(allUsers).filter(user => user.profile && user.profile.content && user.profile.content.profile_user && (user.profile.content.profile_user.username.includes(state.users.search) || user.profile.content.profile_user.first_name.includes(state.users.search) || user.profile.content.profile_user.last_name.includes(state.users.search)))
