...
const organization = {
    ...
    id: 2,
	skills:[{node:{id:1,title:"طراحی صفحات وب و اپلیکیشن",description:"با داشتن 10 سال سابقه فعالیت در زمینه وب و استفاده به روز از ابزار و تکنولوژی های جدید همیشه بهترین کیفیت و پشتیبانی را ارایه کردیم"}},
